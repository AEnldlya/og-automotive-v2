...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // Title lines - use clipPath instead of overflow-hidden
    ...
    // Scroll-driven: video fades out, shader fades in
  ...
  return (
    ...
    >
      {/* Layer 1: Video background — fades on scroll */}
      <video
        ref={videoRef}
      ...
      {/* Layer 2: WebGL Shader — starts subtle, intensifies on scroll */}
      <div className="shader-layer absolute inset-0 opacity-20">
        <HeroShader />
      </div>
      ...
      <div className="relative z-10 h-full flex flex-col justify-end pb-24 px-8 lg:px-16 max-w-7xl mx-auto w-full">
        ...
        {/* Main headline — NO overflow-hidden, using clipPath for animation */}
        <div className="mb-6 lg:mb-8">
          <h1 className="font-bebas mb-0" style={{ fontSize: 'clamp(5rem, 14vw, 13rem)', lineHeight: 0.92 }}>
        ...
        {/* CTA Row — both buttons same height, horizontal */}
        <div className="flex flex-row items-center gap-4 lg:gap-6 mb-16 lg:mb-24 flex-wrap">
